...
netacad.views.BackgroundsView.prototype.build = function() {
  ...
  for (var i = 0; i < backgrounds.length; i++) {
    /*
     * <li>
     *   <input type="image" value="ioe-bg-name" src="course/common/backgrounds/ioe-bg-name-S.jpg" alt="Background image"/>
     * </li>
     */
    var background = backgrounds[i];
    ...
    input.setAttribute("alt", netacad.lang.get("BackgroundImage"));
