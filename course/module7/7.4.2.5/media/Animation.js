...
(lib.ID_txt07 = function() {
	...
	// ID_txt07
	this.text = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt07", size:"10", width:"130", expand:"up",class:"orangeCallOut"}); 
...
(lib.ID_txt06 = function() {
	...
	// ID_txt06
	this.text = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt06",size:"10", width:"146", expand:"up",class:"orangeCallOut"}); 
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
...
(lib.moreInfo_bg = function() {
	...
	// lines
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("AClCHIlJAAAClAtIlJAAACliGIlJAAAClgsIlJAA");
...
(lib.Main = function() {
	...
	this.anim01.setTransform(100,10);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,470,400);
